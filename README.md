...
Gemini HTTP 429: expliciet afgewezen aanroepen worden apart geregistreerd met $0 geraamde analysekosten. Bij een tijdelijke limiet volgen maximaal twee herpogingen na minstens 15 en 30 seconden, rekening houdend met een numerieke Retry-After of retryDelay. Wachttijden boven 120 seconden en expliciete dag-/factureringslimieten stoppen de ronde met een melding. Tijdens wachten blijven annuleren en budgetcontroles actief. Time-outs en onbekend verbruik worden niet automatisch herhaald. Deze afhandeling verhoogt geen Google-quota; de werkelijke factuur blijft leidend.
